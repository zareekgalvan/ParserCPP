...
print("includes totales" + " " + str(contIncludeTotal))
print("includes correctos" + " " + str(contInclude))
print("comentarios m" + " " + str(contComentarioM))
print("comentarios s" + " " + str(contComentarioS))
...
print("nombre de archivo correcto" + " " + str(contFN))
